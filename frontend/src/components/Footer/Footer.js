        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-300">
              A personal portfolio website showcasing my professional profile, 
              sharing knowledge through a blog, and providing an interactive 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/reading" className="text-gray-300 hover:text-white transition-colors">
                  Reading
                </Link>
              </li>
              <li>
